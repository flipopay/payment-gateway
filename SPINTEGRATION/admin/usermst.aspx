<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin_mst.Master" AutoEventWireup="true" CodeBehind="usermst.aspx.cs" Inherits="SPINTEGRATION.admin.usermst" %>
                  ...
                  <div class="card-body">
                                <form method="POST" class="needs-validation" novalidate="" runat="server">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-6">
                                            <label>Mobile</label>
                                            <asp:TextBox ID="txt_mobile" runat="server" onkeypress="return ValidNumeric()" placeholder="Mobile Number" class="form-control" required></asp:TextBox>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group col-6">
                                            <label>GSTIN</label>
                                            <asp:TextBox ID="txt_GST" name="gstvalue" AutoPostBack="false" runat="server" class="form-control"  placeholder="Company GSTIN" required></asp:TextBox>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <asp:TextBox ID="txt_Pin" runat="server" onkeypress="return ValidNumeric()" class="form-control" placeholder="Pin Code" required></asp:TextBox>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <SCRIPT language=Javascript>
                                            ...
                                            function ValidateGSTNumber() {
                                                var gstNumber = document.getElementById('#txtGSTNumber');
                                                alert(gstNumber);
