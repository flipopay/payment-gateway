<%@ Page Title="" Language="C#" MasterPageFile="~/merchant/merchant_mst.Master" AutoEventWireup="true" CodeBehind="dashboardpayout.aspx.cs" Inherits="SPINTEGRATION.merchant.dashboardpayout" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="section">
        <h1 class="section-header">
            <div>Payout Dashboard</div>
        </h1>
        <div class="row">
